        ...
        if (registrationForm.valid) {
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                if (registrationForm.validForm) {
                    ...
                    var contentProductsIds = content.custom.body.markup.split(',');
                    
                    var data = [];
                    
                    for (let index = 0; index < contentProductsIds.length; index++) {
                        var product = ProductMgr.getProduct(contentProductsIds[index]);
